...
new class extends Component {
    ...
    public function deleteTeam(): void
    {
        ...
        if ($validated['deleteName'] !== $this->team->name) {
            $this->addError('deleteName', __('The Spiritist Center name does not match.'));
        ...
        Flux::toast(variant: 'success', text: __('Spiritist Center deleted.'));
...
<flux:modal name="delete-team" :show="$errors->isNotEmpty()" focusable class="max-w-lg">
    <form wire:submit="deleteTeam" class="space-y-6">
        <div>
            ...
            <flux:subheading>
                {{ __('This action cannot be undone. This will permanently delete the Spiritist Center ":name".', ['name' => $team->name]) }}
            </flux:subheading>
        </div>
        ...
        <div class="flex justify-end space-x-2 rtl:space-x-reverse">
            ...
            <flux:button variant="danger" type="submit" wire:loading.attr="disabled" data-test="delete-team-confirm">
